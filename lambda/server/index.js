...
const DealInput = z.object({
  ...
  relationshipStrength: z.enum(['New','Good','Strategic']),
  customerTechSophistication: z.enum(['Low','Medium','High']),
  dealRegType: z.enum(['NotRegistered','StandardApproved','PremiumHunting','Teaming']),
  competitors: z.enum(['0','1','2','3+']),
  valueAdd: z.enum(['Low','Medium','High']),
  solutionComplexity: z.enum(['Low','Medium','High']),
  varStrategicImportance: z.enum(['Low','Medium','High']),
