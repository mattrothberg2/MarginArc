...
import FulcrumManagerDashboard from "c/fulcrumManagerDashboard";
import getPipelineSummary from "@salesforce/apex/FulcrumManagerController.getPipelineSummary";
import getHistoricalPerformance from "@salesforce/apex/FulcrumManagerController.getHistoricalPerformance";
// eslint-disable-next-line no-unused-vars
import getUserContext from "@salesforce/apex/FulcrumManagerController.getUserContext";
// eslint-disable-next-line no-unused-vars
import getTeamComparison from "@salesforce/apex/FulcrumManagerController.getTeamComparison";

// Mock Apex wire adapters using createApexTestWireAdapter
jest.mock(
  "@salesforce/apex/FulcrumManagerController.getPipelineSummary",
  () => {
...
jest.mock(
  "@salesforce/apex/FulcrumManagerController.getHistoricalPerformance",
  () => {
    const { createApexTestWireAdapter } = require("@salesforce/sfdx-lwc-jest");
    return { default: createApexTestWireAdapter(jest.fn()) };
  },
...
jest.mock(
  "@salesforce/apex/FulcrumManagerController.getUserContext",
  () => {
    const { createApexTestWireAdapter } = require("@salesforce/sfdx-lwc-jest");
    return { default: createApexTestWireAdapter(jest.fn()) };
  },
...
jest.mock(
  "@salesforce/apex/FulcrumManagerController.getTeamComparison",
  () => {
    const { createApexTestWireAdapter } = require("@salesforce/sfdx-lwc-jest");
    return { default: createApexTestWireAdapter(jest.fn()) };
  },
...
jest.mock(
  "@salesforce/apex/FulcrumManagerController.getRepDetail",
  () => jest.fn(),
  { virtual: true }
);
...
function createComponent() {
  const element = createElement("c-fulcrum-manager-dashboard", {
    is: FulcrumManagerDashboard
  });
...
describe("c-fulcrum-manager-dashboard", () => {
  afterEach(() => {
