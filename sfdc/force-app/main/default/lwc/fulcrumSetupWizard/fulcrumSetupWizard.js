...
import getSetupStatus from "@salesforce/apex/FulcrumSetupController.getSetupStatus";
import getFieldMappingSuggestions from "@salesforce/apex/FulcrumSetupController.getFieldMappingSuggestions";
import runBackfill from "@salesforce/apex/FulcrumSetupController.runBackfill";
import getBackfillJobStatus from "@salesforce/apex/FulcrumSetupController.getBackfillJobStatus";
import runNightlyAnalyzer from "@salesforce/apex/FulcrumSetupController.runNightlyAnalyzer";
import getMaturityAssessment from "@salesforce/apex/FulcrumSetupController.getMaturityAssessment";
import loadDemoData from "@salesforce/apex/FulcrumDemoDataLoader.loadDemoData";
...
export default class FulcrumSetupWizard extends NavigationMixin(
  LightningElement
) {
  // ── Wizard State ──
  @track currentStep = 1;
  ...
  get connectionWarning() {
    ...
    if (!this.setupStatus.apiConfigured) {
      return "Configure your API settings in MarginArc Config custom setting. Go to Setup > Custom Settings > Fulcrum Config to set the API URL and API Key.";
    }
