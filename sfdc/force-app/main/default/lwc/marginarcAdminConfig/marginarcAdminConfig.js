...
import getOemList from "@salesforce/apex/MarginArcAdminController.getOemList";
import saveOem from "@salesforce/apex/MarginArcAdminController.saveOem";
import deleteOem from "@salesforce/apex/MarginArcAdminController.deleteOem";
import getCompetitorList from "@salesforce/apex/MarginArcAdminController.getCompetitorList";
import saveCompetitor from "@salesforce/apex/MarginArcAdminController.saveCompetitor";
import deleteCompetitor from "@salesforce/apex/MarginArcAdminController.deleteCompetitor";
import getDataHealth from "@salesforce/apex/MarginArcAdminController.getDataHealth";
import getConnectionStatus from "@salesforce/apex/MarginArcAdminController.getConnectionStatus";
import activateLicense from "@salesforce/apex/MarginArcLicenseActivator.activateLicense";
import getLicenseStatus from "@salesforce/apex/MarginArcLicenseActivator.getLicenseStatus";
import validateLicenseNow from "@salesforce/apex/MarginArcLicenseValidator.validateLicenseNow";

function n(val) {
  return val == null ? 0 : Number(val);
}

export default class MarginarcAdminConfig extends LightningElement {
  // ── License Management ──
