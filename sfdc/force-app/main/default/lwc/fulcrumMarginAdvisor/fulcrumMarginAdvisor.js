...
import callFulcrumApi from "@salesforce/apex/FulcrumController.callFulcrumApi";
import getOemRecords from "@salesforce/apex/FulcrumController.getOemRecords";
import getRecommendationHistory from "@salesforce/apex/FulcrumController.getRecommendationHistory";
import logRecommendation from "@salesforce/apex/FulcrumController.logRecommendation";
...
import getCompetitorRecords from "@salesforce/apex/FulcrumAdminController.getCompetitorList";
// Widget version
...
export default class FulcrumMarginAdvisor extends LightningElement {
  @api recordId;
  ...
  mapOpportunityData(data) {
    ...
    const fulcrumOem = fields.Fulcrum_OEM__c?.value;
    const oem = fulcrumOem || this.deriveOemFromName(name);
  ...
  async handleConfirmApply() {
    ...
    try {
      ...
      try {
        ...
        const resultJson = await callFulcrumApi({
  ...
  async fetchRecommendation() {
    ...
    try {
      ...
      try {
        ...
        const resultJson = await callFulcrumApi({ payload: apiPayload });
